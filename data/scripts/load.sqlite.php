...
$getOptions = new Zend_Console_Getopt(array(
...
if ( $getOptions->getOption('h') )
{
    echo $getOptions->getUsageMessage();
    return true;
}

// Initialize values based on presence or absence of CLI options
$withData = $getOptions->getOption('w');
$env      = $getOptions->getOption('e');
